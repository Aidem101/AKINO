  ...
  <section class="Form-Login">
      ...
      <div class="Form-login">
        <div class="Form-Title">
          <p>Войдите или создайте аккаунт в <img src="logo.svg" alt="logo"></p>

        </div>
        <form class="login-form">
          <!-- Обертка, которая имитирует поле ввода -->
          <div class="input-wrapper">
            <!-- Стилизованный префикс -->
            <div class="phone-prefix">+7</div>
            <!-- Само поле ввода (прозрачное) -->
            <input type="tel" placeholder="(999) 000-00-00" pattern="[0-9]*" class="telefon_form_input" required>
          </div>
          
          <input type="submit" value="Продолжить" class="login-btn">
        </form>
        <div class="polz-sogl">
          Нажимая “Продолжить”, я принимаю условия <a href="">Пользовательского соглашения</a> ООО “AKINO”
        </div>
